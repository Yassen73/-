...
<head>
    ...
    <title>أحاديث | موقع ويب متقدم</title>
    <style>
        /* تخصيصات CSS */
        body {
    ...
    <script>
        ...
        const allHadiths = {
            ...
            fasting: [
                ...
                { text: "عن عبد الله بن عباس -رضي الله عنه- قال: قال رسول الله -صلى الله عليه وسلم-: «إذا دخل رمضان فتحت أبواب الجنة، وغلقت أبواب النار، وصفدت الشياطين»." },
